merging https://github.com/reriiasu/speech-to-text and https://github.com/roatienza/efficientspeech
...
Create your own virtual environment and install requirements.txt for both repos. One is in parent folder while other one is in speech_to_text
```
