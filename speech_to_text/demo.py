...
# def demo_main(input_text=None):
args = get_args()
# if input_text:
#     args.text = str(input_text)
#     args.checkpoint='tiny_eng_266k.ckpt'
    # args.infer-device='cpu'
print('------input_text:', args.text)
...
#     demo_main(' Very well done')

def main_dummy(input_text):
    if input_text:
        args.text = str(input_text)
        # args.checkpoint='tiny_eng_266k.ckpt'
        # args.infer-device='cpu'
